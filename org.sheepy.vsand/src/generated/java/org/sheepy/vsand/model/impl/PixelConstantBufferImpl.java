...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pixel Constant Buffer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.vsand.model.impl.PixelConstantBufferImpl#getBoardConstantBuffer <em>Board Constant Buffer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PixelConstantBufferImpl extends BoardConstantBufferImpl implements PixelConstantBuffer
{
	...
	{
		return VSandPackage.Literals.PIXEL_CONSTANT_BUFFER;
	}
		...
		if (boardConstantBuffer != null && ((EObject)boardConstantBuffer).eIsProxy())
		{
			...
			if (boardConstantBuffer != oldBoardConstantBuffer)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VSandPackage.PIXEL_CONSTANT_BUFFER__BOARD_CONSTANT_BUFFER, oldBoardConstantBuffer, boardConstantBuffer));
			}
		}
	...
	public void setBoardConstantBuffer(BoardConstantBuffer newBoardConstantBuffer)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VSandPackage.PIXEL_CONSTANT_BUFFER__BOARD_CONSTANT_BUFFER, oldBoardConstantBuffer, boardConstantBuffer));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case VSandPackage.PIXEL_CONSTANT_BUFFER__BOARD_CONSTANT_BUFFER:
