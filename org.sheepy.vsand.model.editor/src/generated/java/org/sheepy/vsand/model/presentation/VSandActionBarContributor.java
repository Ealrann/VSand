...
/**
 * This is the action bar contributor for the VSand model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VSandActionBarContributor
	...
	implements ISelectionChangedListener
{
	...
	protected IAction showPropertiesViewAction =
		new Action(VSandEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item"))
		{
			@Override
			public void run()
			{
	...
	protected IAction refreshViewerAction =
		new Action(VSandEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item"))
		{
			@Override
	 ...
	 * @generated
	 */
	public VSandActionBarContributor()
	{
		super(ADDITIONS_LAST_STYLE);
		loadResourceAction = new LoadResourceAction();
		validateAction = new ValidateAction();
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(VSandEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToToolBar(IToolBarManager toolBarManager)
	{
		...
		toolBarManager.add(new Separator("vsand-settings"));
		toolBarManager.add(new Separator("vsand-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager)
	{
		...
		IMenuManager submenuManager = new MenuManager(VSandEditorPlugin.INSTANCE.getString("_UI_VSandEditor_menu"), "org.sheepy.vsand.modelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(VSandEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(VSandEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager)
	{
		...
		submenuManager = new MenuManager(VSandEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(VSandEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
